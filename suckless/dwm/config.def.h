...
static const char col_cyan[]        = "#f19618";
...
const char *spcmd1[] = {"kitty", "--class", "spterm","--config", "/home/sk/.config/kitty/kitty_scrachpad.conf", NULL };
const char *spcmd2[] = {"kitty", "--class", "spfm", "--config", "/home/sk/.config/kitty/kitty_scrachpad.conf", "-e", "ranger", NULL };
...
static const Rule rules[] = {
	...
	{ NULL,      "spfm",   NULL,           SPTAG(0),  1,          0,           1,        -1 }, 
};
